---
title: "Consistent ensemble predictions of intertidal barnacle distributions across visual and eDNA-based occurrence data"
format: html
embed-resources: true
editor: visual
author: Simons D-L, Webb TJ, Spencer M, Mieszkowska N
...
```{r}
#| label: correct_gbif_baseline_semibalanus
...
```{r}
#| label: correct_gbif_baseline_chthamalus
...
```{r}
#| label: semibalanus-baseline-model-data-checks
...
```{r}
#| label: format-data-bodmod2-semibalanus-baseline
#| echo: true
#| results: hide
...
```{r}
#| label: chthamalus-baseline-model-data-checks
...
```{r}
#| label: format-data-bodmod2-chthamalus-baseline
#| echo: true
#| results: hide
...
```{r}
#| label: cross-val-semibalanus-baseline
...
```{r}
#| label: cross-val-chthamalus-baseline
...
```{r}
#| label: run-model-semibalanus-baseline-single
#| echo: true
#| results: hide
...
```{r}
#| label: make-and-save-figures-semi-bal-baseline-individual
#| echo: true
#| results: hide
...
```{r}
#| label: run-model-semibalanus-baseline-ensemble
#| echo: true
#| results: hide
...
```{r}
#| label: make-and-save-figures-semi-bal-baseline-ensemble
#| echo: true
#| results: hide
...
```{r}
#| label: run-model-chthamalus-baseline-single
#| echo: true
#| results: hide
...
```{r}
#| label: make-and-save-figures-chthamalus-baseline-individual
#| echo: true
#| results: hide
...
```{r}
#| label: run-model-chthamalus-baseline-ensemble
#| echo: true
#| results: hide
...
```{r}
#| label: make-and-save-figures-chthamalus-baseline-ensemble
#| echo: true
#| results: hide
...
```{r}
#| label: SB-baseline-response-curve
#| message: false
#| results: false
...
```{r}
#| label: CM-baseline-response-curve
#| message: false
#| results: false
